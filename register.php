...
<head>
    ...
    <title>Sistem Kendali Otomatis | Register</title>
...
<body class="bg-gradient-primary">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-1 col-md-9">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img class="mb-4" src="assets/img/logo_unpam.png" alt="" width="86" height="86">
                                        <h1 class="h4 text-gray-900 mb-4">Sistem Kendali Otomatis</h1>
                                    ...
                                    <form class="user" action="" method="post">
                                        ...
                                        <br>
                                        <button class="btn btn-primary btn-user btn-block" name="register" type="submit">Register   
                                        </button> 
                                        </a>   
                                    </form>
                                    <br>
