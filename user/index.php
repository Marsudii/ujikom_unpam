                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card mb-9">
                                ...
                                <h4 class="m-0 font-weight-bold text-primary">Selamat Datang Di Sistem Kendali Otomatis </h4>
                                </div>
                                </div>
                                <div class="card-body" class="text-center">
                                     <p class="text-center"> Halo <b><?php echo $username;?></b>, Selamat datang di Sistem kendali otomatis<br/>Sebuah web apps sederhana yang berfungsi untuk melakukan pengontrolan sebuah alat-alat elektronik anda.
                                     </p>
                                </div>
                            </div>
                        </div>
